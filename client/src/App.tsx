...
const App = () => {
  ...
  return (
    <div className="grid grid-cols-[30%_70%]">
      ...
      <div className="flex flex-col justify-center items-center h-screen bg-zinc-100 text-neutral-900">
      ...
      <div className="flex flex-col justify-center items-center h-screen bg-neutral-900 text-zinc-100">
